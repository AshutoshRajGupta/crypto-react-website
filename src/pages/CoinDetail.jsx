...
// here we are using id as params to show the details regarding particular coin here so we need api call for particular id as well.
// in api we have a function name fetchCoinData which extracts particular coin data and we are loading it here
// we have define a useEffect such that whenever id is changeing we nned the function to reload page with speciific coin id data.
